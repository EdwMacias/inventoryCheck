...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/devalue/index.js';
import destr from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/consola/dist/index.mjs';
import devalue from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/EdwMacias/Documents/github/inventoryCheck/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/EdwMacias/Documents/github/inventoryCheck/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/EdwMacias/Documents/github/inventoryCheck","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/EdwMacias/Documents/github/inventoryCheck/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/EdwMacias/Documents/github/inventoryCheck/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/EdwMacias/Documents/github/inventoryCheck/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/EdwMacias/Documents/github/inventoryCheck/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _YBvzSHHEnS = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/EdwMacias/Documents/github/inventoryCheck";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _QQVr9NWB0O = (nitroApp) => {
...
const _lazy_OIL7wK = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_OIL7wK, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_OIL7wK, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Chequeo Inventario","charset":"utf-8","viewport":"width=device-width, initial-scale=1"};
...
const getClientManifest = () => import('file:///Users/EdwMacias/Documents/github/inventoryCheck/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/EdwMacias/Documents/github/inventoryCheck/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
