    ...
    <template #user-action="props">
      <div class="dropdown dropdown-left">
        ...
        <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
          <li><a @click="clickInDetails(props.rowData.correo)">Detalles</a></li>
        </ul>
      </div>
    </template>
  </DataTable>
...
import { GET_TABLE_TERCERO_JURIDICO } from '~/Infrastructure/Connections/endpoints.connection';
...
const columns: ConfigColumns[] = [
  ...
  {
    data: 'razonSocial', title: 'Razon Social', searchable: true,
    orderable: false
  },
  {
    data: 'nit', title: 'NIT', searchable: true,
    orderable: false
  },
  {
...
const settingRequest: any = {
  url: GET_TABLE_TERCERO_JURIDICO,
  method: 'GET',
  headers: {
