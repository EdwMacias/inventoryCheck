    ...
    <template #user-action="props">
      ...
      <div class="navbar-center hidden lg:flex">
        <ul class="menu menu-horizontal px-1">
          ...
          <li>
            <details>
              <summary class="border bg-neutral-content">Acciones</summary>
              <ul class="p-2" style="z-index: 10000;">
                <li>
                ...
                <li>
                  <a @click="inactive(props.rowData)">
                    <svg v-if="props.rowData.statu_id != 1" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <li>
                  <label for="modalFormularioRole" class="text-dark" @click="buttonRole(props.rowData)">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                      <path fill-rule="evenodd"
